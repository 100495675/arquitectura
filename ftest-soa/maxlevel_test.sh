...
max_level_normal_uint8_1() {
    ...
    local OUTPUT_FILE="$2/../images/soa-output/maxlevel-deer-small.ppm"
    local OPERATION="maxlevel"
    local LEVEL="255"
    local COMMAND="../imtool-soa/imtool-soa $INPUT_FILE $OUTPUT_FILE $OPERATION $LEVEL"
...
max_level_normal_uint8_2() {
    ...
    local OUTPUT_FILE="$2/../images/soa-output/maxlevel-lake-small-255.ppm"
    local OPERATION="maxlevel"
    local LEVEL="255"
    local COMMAND="../imtool-soa/imtool-soa $INPUT_FILE $OUTPUT_FILE $OPERATION $LEVEL"
...
max_level_normal_uint16_1() {
    local INPUT_FILE="$2/../images/input/deer-small.ppm"
    local OUTPUT_FILE="$2/../images/soa-output/maxlevel-deer-small-65535.ppm"
    local OPERATION="maxlevel"
    local LEVEL="65535"
    local COMMAND="../imtool-soa/imtool-soa $INPUT_FILE $OUTPUT_FILE $OPERATION $LEVEL"
...
max_level_normal_uint16_2() {
    local INPUT_FILE="$2/../images/input/lake-small.ppm"
    local OUTPUT_FILE="$2/../images/soa-output/maxlevel-lake-small-65535.ppm"
    local OPERATION="maxlevel"
    local LEVEL="65535"
    local COMMAND="../imtool-soa/imtool-soa $INPUT_FILE $OUTPUT_FILE $OPERATION $LEVEL"
...
maxlevel_too_many_args() {
    ...
    local LEVEL="100"
    local EXTRA="100"
    local COMMAND="../imtool-soa/imtool-soa $INPUT_FILE $OUTPUT_FILE $OPERATION $LEVEL $EXTRA"
...
maxlevel_limite() {
    ...
    local OUTPUT_FILE="$2/../images/soa-output/image-maxlevel-65536.ppm"
    local OPERATION="maxlevel"
    local LEVEL="65536"
    local COMMAND="../imtool-soa/imtool-soa $INPUT_FILE $OUTPUT_FILE $OPERATION $LEVEL"
